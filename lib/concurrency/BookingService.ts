...
class BookingConcurrencyService {
  ...
  public async executeAtomicBooking(
    ...
    // 5. ATOMIC SEAT ALLOCATION & MONGODB TRANSACTION
    // Use MongoDB Session & Transaction where supported (Replica Set / Atlas)
    ...
    try {
      ...
      console.error("Booking Transaction Failure:", transactionError);
      return {
        success: false,
