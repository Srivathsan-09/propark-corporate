  ...
  useEffect(() => {
    ...
    if (
      ...
      const vehicleSvg = isBike
        ? `<svg class="h-4 w-4 text-white" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="5.5" cy="17.5" r="3.5"/><circle cx="18.5" cy="17.5" r="3.5"/><path d="M15 6a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-3 11.5L9 9l3-3 3 4.5 4 1"/></svg>`
        : `<svg class="h-4 w-4 text-white" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.5 2.7C2.1 10.6 2 10.8 2 11v5c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/></svg>`;
      const icon = L.divIcon({
        ...
        html: `
          <div class="relative flex items-center justify-center cursor-pointer group" style="transform: translate(-50%, -50%);">
            ...
            <div class="relative flex h-10 w-10 items-center justify-center rounded-full bg-slate-900 border-2 border-white text-white shadow-xl transition-transform hover:scale-110">
              ${vehicleSvg}
            </div>
    ...
    // 4b. LIVE MOVING PASSENGER GPS MARKER
    if (
      passengerLocation &&
      ...
      const passengerSvg = `<svg class="h-4 w-4 text-white" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>`;
      const icon = L.divIcon({
        ...
        html: `
          <div class="relative flex items-center justify-center cursor-pointer group" style="transform: translate(-50%, -50%);">
            ...
            <div class="relative flex h-10 w-10 items-center justify-center rounded-full bg-indigo-900 border-2 border-white text-white shadow-xl transition-transform hover:scale-110">
              ${passengerSvg}
            </div>
